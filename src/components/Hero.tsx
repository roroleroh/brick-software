export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[1160px] mx-auto px-6 pt-28 pb-20 flex flex-col lg:flex-row items-center gap-16">
        {/* Text */}
        ...
        <div className="hidden lg:flex shrink-0 items-center justify-center">
          <img
            src="/logo.png"
            alt="Brick Software"
            className="w-[320px] h-[320px] object-contain drop-shadow-[0_32px_80px_rgba(26,107,255,0.25)]"
          />
        </div>
      </div>
    </section>
